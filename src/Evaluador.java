public class Evaluador implements IEvaluador {

    @Override
    public Objeto evaluar(Expresion expr, Entorno env) {
    ...
    @Override
    public Objeto evaluarLista(List<Expresion> exprList, Entorno env) {
    ...
    private Objeto evaluarOperacionAritmetica(OperacionAritmetica operacion, Entorno env) {
